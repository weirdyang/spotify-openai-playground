...
const imagePrompt = `Provide a single song genre that closely matches the profile image, be concise, and use information from the tweets. Only reply with the genre, eg. "Lame Political Hiphop"`;
